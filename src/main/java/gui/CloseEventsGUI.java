...
public class CloseEventsGUI extends JFrame {
	...
	private void jbInit() throws Exception {
		...
		this.setSize(new Dimension(554, 328));
		...
		jButtonClose.setBounds(new Rectangle(290, 246, 130, 30));
		...
		jLabelMsg.setBounds(new Rectangle(275, 182, 250, 20));
		jLabelMsg.setForeground(Color.GREEN);
		// jLabelMsg.setSize(new Dimension(305, 20));

		jLabelError.setBounds(new Rectangle(79, 214, 414, 20));
		...
		datesWithEventsCurrentMonth = facade.getOpenEventsMonth(jCalendar.getDate());
		...
		jButtonCloseEvent.setBounds(118, 246, 130, 30);
