...
public class RegisterGUI extends JFrame {
	...
	public RegisterGUI() {
		...
		btnCreateAccount.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (String.valueOf(pw1.getPassword()).contentEquals(String.copyValueOf(pw2.getPassword()))) {
					...
					try {
						facade.createUser(username.getText(), name.getText(), surname.getText(),
								String.valueOf(pw1.getPassword()), email.getText(), referralField.getText());
		...
		JLabel lblConfirmPassword = new JLabel(
				ResourceBundle.getBundle("Etiquetas").getString("ConfirmPassword") + ":");
